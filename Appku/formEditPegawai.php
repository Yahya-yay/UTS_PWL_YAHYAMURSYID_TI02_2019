...
<form method="POST" action="controllers/pegawaiController.php">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="nama" name="nama" value="<?= $edit_data['nama'] ?>" placeholder="Masukan Nama Anda!" type="text" class="form-control" required="required" autocomplete="off">
        </div>
    </div>
    <div class="form-group row">
        <label for="email" class="col-4 col-form-label">Email</label>
        <div class="col-8">
            <input id="email" name="email" value="<?= $edit_data['email'] ?>" placeholder="Masukan Email Anda!" type="text" class="form-control" required="required" autocomplete="off">
        </div>
    </div>
    <div class="form-group row ">
